        ...
        <div class="col-sm-12">
            ...
            <table class="table table-light table-striped">
                ...
                <tr>
                    ...
                    <td>{{ $n->user->name }}</td>
                    <td>
                        <a class="btn btn-sm btn-secondary btn-block" href="{{ route('news.show', $n->id) }}">Show</a>
                        @if($n->featured == 1)
                        ...
                        @else
                        <a href="{{ route('featurenews', $n) }}"class="btn btn-sm btn-success btn-block">Feature</a>
                        @endif
                    </td>
                </tr>
                @endforeach
