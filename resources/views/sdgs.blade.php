                ...
                <div>
                    <a href="{{ route('sdgs.show', $c) }}">
                        @if ($c->name == 'NO POVERTY')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/SDG1.gif" width="200" />
                        @elseif ($c->name == 'ZERO HUNGER')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg2.gif" width="200" />
                        @elseif ($c->name == 'GOOD HEALTH AND WELL-BEING')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg3.gif" width="200" />
                        @elseif ($c->name == 'QUALITY EDUCATION')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg4.gif" width="200" />
                        @elseif ($c->name == 'GENDER EQUALITY')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg5.gif" width="200" />
                        @elseif ($c->name == 'CLEAN WATER AND SANITATION')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg6.gif" width="200" />
                        @elseif ($c->name == 'AFFORDABLE AND CLEAN ENERGY')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg7.gif" width="200" />
                        @elseif ($c->name == 'DECENT WORK AND ECONOMIC GROWTH')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg8.gif" width="200" />
                        @elseif ($c->name == 'INDUSTRY INNOVATION AND INFRASTRUCTURE')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg8.gif" width="200" />
                        @elseif ($c->name == 'REDUCED INEQUALITIES')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg10.gif" width="200" />
                        @elseif ($c->name == 'SUSTAINABLE CITIES AND COMMUNITIES')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg11.gif" width="200" />
                        @elseif ($c->name == 'RESPONSIBLE CONSUMPTION AND PRODUCTION')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg12.gif" width="200" />
