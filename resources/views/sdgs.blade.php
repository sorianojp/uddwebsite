                ...
                <div>
                    <a href="{{ route('sdgs.show', $c) }}">
                        ...
                        @elseif ($c->name == 'GENDER EQUALITY')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg5.gif" width="150"
                                class="img-hover" />
                        @elseif ($c->name == 'CLEAN WATER AND SANITATION')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg6.gif" width="150"
                                class="img-hover" />
                        @elseif ($c->name == 'AFFORDABLE AND CLEAN ENERGY')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg7.gif" width="150"
                                class="img-hover" />
                        @elseif ($c->name == 'DECENT WORK AND ECONOMIC GROWTH')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg8.gif" width="150"
                                class="img-hover" />
                        @elseif ($c->name == 'INDUSTRY INNOVATION AND INFRASTRUCTURE')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg9.gif" width="150"
                                class="img-hover" />
                        @elseif ($c->name == 'REDUCED INEQUALITIES')
                            <img src="https://sdg.neda.gov.ph/wp-content/uploads/2022/09/sdg10.gif" width="150"
                                class="img-hover" />
